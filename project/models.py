...
class User(db.Model):
    ...
    dosen_profile = db.relationship('Dosen', backref='user_account', uselist=False, cascade="all, delete-orphan")
...
class Booking(db.Model):
    ...
    dosen = db.relationship('Dosen', foreign_keys=[dosen_id], backref=db.backref('bookings', lazy=True))
