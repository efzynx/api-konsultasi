...
def get_models(api):
    ...
    success_response_model = api.model(
        "SuccessResponse",
        {
            "success": fields.Boolean(
                required=True, description="Operation success status"
            ),
    ...
    login_response_model = api.model(
        ...
        {
            "success": fields.Boolean(
                required=True, description="Login success status"
            ),
            "message": fields.String(required=True, description="Response message"),
    ...
    dosen_update_model = api.model(
        "DosenUpdate",
        {
            "nama_dosen": fields.String(
                description="Dosen name", example="Dr. Jane Smith"
            ),
            "mata_kuliah": fields.String(
    ...
    dosen_list_response_model = api.model(
        "DosenListResponse",
        {
            "success": fields.Boolean(
                required=True, description="Operation success status"
    ...
    booking_model = api.model(
        "Booking",
        {
            ...
            "topik_konsultasi": fields.String(
                required=True, description="Consultation topic"
            ),
            "status": fields.String(required=True, description="Booking status"),
        },
    )

    booking_create_model = api.model(
        "BookingCreate",
        {
            ...
            "dosen_id": fields.Integer(
                required=True, description="Dosen ID", example=1
            ),
            "tanggal": fields.String(
                required=True,
            ...
            "jam": fields.String(
                required=True,
                description="Consultation time (HH:MM:SS)",
                example="14:00:00",
            ),
            "topik_konsultasi": fields.String(
                required=True,
    ...
    booking_update_model = api.model(
        "BookingUpdate",
        {
            "tanggal": fields.String(
    ...
    booking_list_response_model = api.model(
        "BookingListResponse",
        {
            "success": fields.Boolean(
                required=True, description="Operation success status"
    ...
    password_change_model = api.model(
        "PasswordChange",
        {
            ...
            "new_password": fields.String(
                required=True, description="New password (min 6 characters)"
            ),
        },
    )

    # Generic data response
    data_response_model = api.model(
        "DataResponse",
        {
            "success": fields.Boolean(
                required=True, description="Operation success status"
