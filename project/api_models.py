...
user_model = {
    ...
    'role': fields.String(required=True, description='User role', enum=['mahasiswa', 'dosen'])
}
...
user_register_model = {
    ...
    'role': fields.String(description='User role', default='mahasiswa', enum=['mahasiswa', 'dosen'])
}
...
booking_model = {
    ...
    'status': fields.String(required=True, description='Booking status', enum=['pending', 'approved', 'rejected'])
}
...
booking_update_model = {
    ...
    'status': fields.String(description='Booking status (dosen only)', enum=['pending', 'approved', 'rejected'])
}
